    ...
    <>
      ...
      <div className="min-h-screen w-full bg-[#010101] flex items-center justify-center px-6">
        <div className="text-center">
          {/* 500 Number */}
          <h1 className="text-8xl md:text-9xl font-bold leading-none text-white mb-20">500</h1>

          {/* Text content */}
          <h2 className="text-2xl md:text-4xl font-bold text-white mb-3">Internal Server Error</h2>
