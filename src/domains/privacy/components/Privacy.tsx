...
import { privacyPolicyContent } from '@privacy-constants/index';
...
const Privacy = () => {
  ...
  return (
    <div className="px-7">
      ...
      <div className="grid max-w-6xl px-18 gap-10 py-20 md:grid-cols-[220px_1fr] lg:gap-16">
        <div className="flex flex-col">
          <p className="text-md text-gray-600  leading-relaxed  sm:text-lg  md:h-max">
            {privacyPolicyContent.lastUpdated}
          </p>
          <p className="text-md leading-relaxed text-bold font-bold md:h-max">
            {privacyPolicyContent.on}
          </p>
        </div>
